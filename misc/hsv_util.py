...
def hsv_thresholding(image,L_lower, L_upper, a_lower, a_upper, b_lower, b_upper):
...
def main(argv):
    ...
    image = cv2.imread('segmentation-images-test/sample_7.png')
    ...
    while(True):
        ...
        hsv_img = hsv_thresholding(lab_image, L_lower, L_upper, a_lower, a_upper, b_lower, b_upper)
        # Display the image 
